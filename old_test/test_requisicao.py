...
class TestDadosEnvio(mox.MoxTestBase):
    ...
    def test_valida_nome_sem_espaco(self):
        ...
        self.enviar.nome_cliente.should.be.equal("NOME x")
    ...
    def test_valida_nome_com_e_comercial(self):
        ...
        self.enviar.nome_cliente.should.be.equal("NOME E NOME")

    def test_valida_nome_com_ponto_interrogacao(self):
        self.pedido.cliente.nome = "NOME ? NOME"
        self.enviar.nome_cliente.should.be.equal("NOME NOME")
    ...
    def test_valida_nome_com_utf_8(self):
        ...
        self.enviar.nome_cliente.should.be.equal("Calcado So")
